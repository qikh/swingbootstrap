...
public class FontAwesome {
	...
	private FontAwesome() {
		...
		try {
			fontStream = FontAwesomeIcon.class.getResourceAsStream("/font-awesome/fonts/fontawesome-webfont.ttf");
	...
	private static class LazyHolder {
		private static final FontAwesome INSTANCE = new FontAwesome();
	}
