...
import swingbootstrap.fontawesome.FontAwesome;
import swingbootstrap.fontawesome.FontAwesomeIcon;
...
public class ComponentsPanel extends JPanel {
	...
	public ComponentsPanel() {
		...
		brandPanel.setLayout(new MigLayout("gap 0, insets 0", "[100%]", "50[100]20[100]50"));
		add(brandPanel, "cell 0 0 1 1, grow");

		JLabel logoLabel = new JLabel("Components");
		...
		JLabel motoLabel = new JLabel(
				"<html>Over a dozen reusable components built to provide iconography, dropdowns, input groups, navigation, alerts, and much more.</html>");
